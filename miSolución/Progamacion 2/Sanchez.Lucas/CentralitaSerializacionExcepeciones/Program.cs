...
namespace CentralitaSerializacionExcepeciones
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Local local1 = new Local("1234", "4321", 30f, 2.65f);
            Provincial provincial1 = new Provincial("4444", Franja.Franja_1, 21f, "5555");
            Local local2 = new Local("9999", "3333", 45f, 1.99f);
            ...
            {
                Console.WriteLine("La excepción es: {0}\n La clase que la causó es: {1}\n El método que lo causó es: {2}\n", cE.Message, cE.NombreClase, cE.NombreMetodo);
            }
            ...
            {
                Console.WriteLine("La excepción es: {0}\nLa clase que la causó es: {1}\nEl método que lo causó es: {2}\nDatos completos: {3}\n", C.Message, C.NombreClase, C.NombreMetodo, C.ExcepcionInterna);
            }
            ...
            {
                Console.WriteLine("La excepción es: {0}\nLa clase que la causó es: {1}\nEl método que lo causó es: {2}\n", C.ExcepcionInterna.Message, C.NombreClase, C.NombreMetodo);
            }
