...
namespace Entidades_2017
{
    ...
    {
        public Producto(string codBarras, EMarca marca, ConsoleColor color)
        {
            this._marca = marca;
        ...
        public override bool Equals(object obj)//sobreescribo el metodo virtual de object llamado Equals para comparar 
        {                                      //2 objetos y saber si son iguales. Esto ademas usa el == sobrecargado de
            return (this == (Producto)obj);    //arriba, dentro de este método.
        }
