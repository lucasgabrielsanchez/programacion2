...
{
    public class DepositoDeBicicletas
    {
        private int _capacidadMaxima;
        private List<Bicicleta> _lista;

        public DepositoDeBicicletas(int capacidad)
        {
            this._lista = new List<Bicicleta>(); 
            this._capacidadMaxima = capacidad;
        }

        public static bool operator +(DepositoDeBicicletas d, Bicicleta a)
        {
            bool aux = false;
        ...
        private int GetIndice(Bicicleta a)
        {
            int aux = -1;
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine("Listado de bicicletas:");
